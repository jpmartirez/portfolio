				...
				<div className="flex items-center justify-between px-5 py-4 border-b border-white/10 bg-white/3">
					<div className="space-y-0.5 pr-4">
						<span className="text-[11px] font-semibold uppercase tracking-wider text-cyan-400">
							{certification.category} &bull;{" "}
							{certification.fileType.toUpperCase()}
						</span>
						<h2
					...
					<div className="flex items-center gap-2 shrink-0">
						{certification.verifyUrl && (
							<a
								...
								className="px-3 py-1.5 rounded-lg text-xs font-semibold text-cyan-300 hover:text-cyan-200 bg-cyan-950/50 hover:bg-cyan-900/60 border border-cyan-500/30 transition-colors"
							>
								Verify
							</a>
						)}
