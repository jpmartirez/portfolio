...
const TECH_STACK: TechItem[] = [
	...
	// Software Solutions
	{
		...
		level: "Core",
		description:
			"Full-stack React framework for modern high-performance web apps",
		icon: (
			<svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
	...
	},
	{
		...
		level: "Core",
		description:
			"Component-driven user interfaces & reactive frontend architecture",
		icon: (
			<svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
	...
	// Tools
	{
		...
		level: "Core",
		description:
			"Version control, continuous integration & open-source collaboration",
		icon: (
			<svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
